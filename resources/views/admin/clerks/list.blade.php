                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <form action="{{ route('admin.clerks.destroy', $clerk->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <a href="{{url('admin/clerks/'.$clerk->id.'/edit')}}" class="btn btn-warning" data-toggle="tooltip" data-original-title="Edit ">
