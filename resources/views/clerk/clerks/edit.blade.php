    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="card-body">
                ...
                <form role="form" method="post" action="{{action('App\Http\Controllers\clerk\ClerksController@update',$clerk->id)}}" enctype="multipart/form-data">
                    <div class="col-md-6 col-6  mt-4">

                        <div class="input-group input-group-outline mb-3 focused is-focused">
                            <label class="form-label">Name</label>
                            <input type="text" class="form-control" name="name" value="{{$clerk->name}}" required  onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>

                        <div class="input-group input-group-outline mb-3 focused is-focused">
                            <label class="form-label">Email</label>
                            <input type="email" class="form-control" name="email" value="{{$clerk->email}}"  onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
