    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="card-body">
                ...
                <form role="form" enctype="multipart/form-data" method="post" action="{{action('App\Http\Controllers\clerk\ItemsController@store')}}">
                    ...
                    <div class="input-group input-group-outline mb-3" style="margin-top: -15px">
                        ...
                        <input type="text" name="ar_item_name" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)">
                    </div>         <br>

                        <div class="input-group input-group-outline mb-3" style="margin-top: -15px">
                            <label class="form-label">AR Description</label>
                            <input type="text" name="ar_description" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                        ...
                        <div class="input-group input-group-outline mb-3" >
                            ...
                            <input type="text" name="discount" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                        <div class="input-group input-group-outline mb-3">
                        ...
                        <br>
                           <div class="input-group input-group-outline mb-3" >
                            ...
                            <input type="text" name="price_time_out" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                    ...
                    <div class="col-md-5 col-6  mt-4 pull-right" style="display: inline-block;padding-left: 18px;">
                        ...
                        <div class="input-group input-group-outline mb-3 " >
                            ...
                            <input type="text" name="en_item_name" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
                        <div class="input-group input-group-outline mb-3" >


                            <label class="form-label">EN Description</label>
                            <input type="text" name="en_description" class="form-control" onfocus="focused(this)" onfocusout="defocused(this)">
                        </div>
