                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <form action="{{ route('clerk.sub-categories.destroy', $cat->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <a href="{{url('clerk/sub-categories/'.$cat->id.'/edit')}}" class="btn btn-warning" data-toggle="tooltip" data-original-title="Edit ">
